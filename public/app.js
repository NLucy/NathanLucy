    ...
    <article class="project-card">
      <div class="project-card-header">
        ...
        <div class="project-card-actions">
          ${project.logo ? `<img class="project-logo" src="${escapeHtml(project.logo)}" alt="" aria-hidden="true">` : ""}
          ${project.href ? `<a class="project-link" href="${escapeHtml(project.href)}" target="_blank" rel="noreferrer">Open</a>` : ""}
        </div>
      </div>
