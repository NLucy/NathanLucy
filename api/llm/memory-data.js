export const memories = [
  ...
  },
  {
    "id": "cortica",
    "title": "Cortica",
    "text": "Cortica is Nathan's confidential, patent-pending long-term state layer for LLM applications. It is proprietary and not public. Public descriptions should stay high level: durable memory, evidence consolidation, directed attention, inspectable state, and evidence-linked insights. It is not a transcript store. Implementation details, internal architecture, storage mechanics, algorithms, prompts, and source code are private."
  },
  {
    "id": "marketmaven",
    "title": "MarketMaven",
